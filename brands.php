                                    ...
                                    <div uk-grid>
                                        ...
                                        <div class="uk-width-1-1 uk-width-expand@m">
                                            <ul class="uk-grid-small uk-child-width-1-2 uk-child-width-1-4@s uk-child-width-1-5@m"
                                                uk-grid>
                                                <li><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
                                                        href="#">
                                                        <div class="tm-ratio tm-ratio-4-3">
                                                            <div class="tm-media-box">
                                                                <figure class="tm-media-box-wrap"><img
                                                                        class="item-brand" src="images/brands/apple.svg"
                                                                        alt="Apple"></figure>
                                                            </div>
                                                        </div>
                                                ...
                                                <li><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
                                                        ...
                                                        <div class="tm-ratio tm-ratio-4-3">
                                                            <div class="tm-media-box">
                                                                <figure class="tm-media-box-wrap"><img
                                                                        class="item-brand" src="images/brands/sony.svg"
                                                                        alt="Sony"></figure>
                                                            </div>
                                                        </div>
                                                ...
                                                <li><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
                                                        ...
                                                        <div class="uk-margin-small-top uk-text-truncate">Microsoft
                                                        </div>
                                                    </a></li>
                                                <li><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
                                                        href="#">
                                                        <div class="tm-ratio tm-ratio-4-3">
                                                            <div class="tm-media-box">
                                                                <figure class="tm-media-box-wrap"><img
                                                                        class="item-brand" src="images/brands/intel.svg"
                                                                        alt="Intel"></figure>
                                                            </div>
                                                        </div>
                                                ...
                                                <li><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
                                                        ...
                                                        <div class="tm-ratio tm-ratio-4-3">
                                                            <div class="tm-media-box">
                                                                <figure class="tm-media-box-wrap"><img
                                                                        class="item-brand" src="images/brands/hp.svg"
                                                                        alt="HP"></figure>
                                                            </div>
                                                        </div>
                                                ...
                                                <li><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
                                                        ...
                                                        <div class="tm-ratio tm-ratio-4-3">
                                                            <div class="tm-media-box">
                                                                <figure class="tm-media-box-wrap"><img
                                                                        class="item-brand" src="images/brands/lg.svg"
                                                                        alt="LG"></figure>
                                                            </div>
                                                        </div>
                                                ...
                                                <li><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
                                                        ...
                                                        <div class="tm-ratio tm-ratio-4-3">
                                                            <div class="tm-media-box">
                                                                <figure class="tm-media-box-wrap"><img
                                                                        class="item-brand" src="images/brands/asus.svg"
                                                                        alt="ASUS"></figure>
                                                            </div>
                                                        </div>
                                                ...
                                                <li><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
                                                        ...
                                                        <div class="tm-ratio tm-ratio-4-3">
                                                            <div class="tm-media-box">
                                                                <figure class="tm-media-box-wrap"><img
                                                                        class="item-brand" src="images/brands/acer.svg"
                                                                        alt="Acer"></figure>
                                                            </div>
                                                        </div>
                                                ...
                                                <li><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
                                                        ...
                                                        <div class="tm-ratio tm-ratio-4-3">
                                                            <div class="tm-media-box">
                                                                <figure class="tm-media-box-wrap"><img
                                                                        class="item-brand" src="images/brands/dell.svg"
                                                                        alt="Dell"></figure>
                                                            </div>
                                                        </div>
                                                ...
                                                <li><a class="uk-link-muted uk-text-center uk-display-block uk-padding-small uk-box-shadow-hover-large"
                                                        ...
                                                        <div class="tm-ratio tm-ratio-4-3">
                                                            <div class="tm-media-box">
                                                                <figure class="tm-media-box-wrap"><img
                                                                        class="item-brand" src="images/brands/canon.svg"
                                                                        alt="Canon"></figure>
                                                            </div>
                                                        </div>
