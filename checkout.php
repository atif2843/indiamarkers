        ...
        <header>
            <div class="uk-navbar-container tm-navbar-container">
                <div class="uk-container" uk-navbar>
                    <div class="uk-navbar-left"><a class="uk-navbar-item uk-logo" href="index.php"><img
                                src="images/logo.png" width="90" height="32" alt="Logo"></a></div>
                    <div class="uk-navbar-right"><a class="uk-navbar-item uk-link-muted" href="tel:+918879856446"><span
                                class="uk-margin-xsmall-right" uk-icon="icon: receiver; ratio: .75;"></span><span
                                class="tm-pseudo">+91 8879856446</span></a></div>
                </div>
            </div>
        </header>
        <main>
            ...
            <div class="uk-section uk-section-secondary uk-section-small uk-light">
                <div class="uk-container">
                    <div class="uk-flex-middle" uk-grid>
                        ...
                        <div><a class="uk-link-muted" href="#"><span class="uk-margin-xsmall-right"
                                    uk-icon="icon: receiver; ratio: .75;"></span><span class="tm-pseudo">8 800 799 99
                                    99</span></a></div>
                    </div>
                </div>
            </div>
