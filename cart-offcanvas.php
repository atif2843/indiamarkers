                                        ...
                                        <div class="uk-width-1-4">
                                            <div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box"
                                                    ...
                                                    <figure class="tm-media-box-wrap"><img
                                                            src="images/products/text-marker.jpg"
                                                            alt="Apple MacBook Pro 15&quot; Touch Bar MPTU2LL/A 256GB (Silver)">
                                                    </figure>
                                                </a></div>
                                        </div>
                                        <div class="uk-width-expand">
                                            <div class="uk-text-meta uk-text-xsmall">Metal Marker</div><a
                                                class="uk-link-heading uk-text-small" href="product.php">Tex Marker</a>
                                    ...
                                    <div class="uk-grid-small" uk-grid>
                                        <div class="uk-width-1-4">
                                            <div class="tm-ratio tm-ratio-4-3"><a class="tm-media-box"
                                                    href="product.php">
                                                    <figure class="tm-media-box-wrap"><img
                                                            src="images/products/stainless-steel.jpg"
                                        ...
                                        <div class="uk-width-expand">
                                            <div class="uk-text-meta uk-text-xsmall">Metal Marker</div><a
                                                class="uk-link-heading uk-text-small" href="product.php">Nuclear Grade Stainless Steel Marker</a>
                                            <div class="uk-margin-xsmall uk-grid-small uk-flex-middle" uk-grid>
